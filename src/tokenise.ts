...
export enum TokenKind {
	...
	Implicit, Import, In, Increment, Initiate, Instanceof, Integer, Interface, Internal, Into, Is, Join, Let, Lock,
	...
	Protected, Public, Readonly, Record, Reference, Remove, Required, Return, Runtime, Satisfies, Scoped, Sealed,
