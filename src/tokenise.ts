...
export enum TokenKind {
	...
	Effect, Else, Enum, Equals, Error, ErrorClean, ErrorDefer, ErrorKeyword, Evaluate, Export, Extends, External, False,
	Final, Finally, Float, Float128Type, Float16Type, Float32Type, Float64Type, For, From, Function, Goto, HexNumber,
	Identifier, If, Implements, Import, In, Increment, Instanceof, Integer, Interface, Internal, Is, Let, LogicalAnd,
	LogicalAndAssign, LogicalNot, LogicalOr, LogicalOrAssign, Long, Loop, Macro, Match, Method, Methods, Minus,
	MinusAssign, Module, Modulo, ModuloAssign, Mutable, Namespace, Native, Never, New, Newline, NoClean, NoReturn,
	NotEquals, NotKeyword, Null, NullishCoalesce, NullishCoalesceAssign, Number, NumberKeyword, Object, OctalNumber, Of,
	Opaque, OpenBracket, OpenSquareBracket, OpenSquiglyBracket, OptionalChain, Or, Override, Package, Power,
	PowerAssign, Primitive, Private, Protected, Public, Readonly, Reference, Return, Runtime, Self, SelfType, ShiftLeft,
	ShiftLeftAssign, ShiftRight, ShiftRightAssign, Short, Signal, SignedIntegerType, Size, Sizeof, SmallerThan,
	SmallerThanEquals, Spaceship, Static, String, Structure, Super, Switch, Symbol, Synchronized, Tag, Test, Tests,
	Then, ThickArrow, This, Throw, Throws, Times, TimesAssign, To, Trait, Traits, Transient, True, Try, Type, Typeis,
	Typeof, Union, UnionKeyword, Unique, Unknown, Unless, Unreachable, Unsafe, Unsigned, UnsignedIntegerType, Unsized,
	Until, Use, Variable, Virtual, Void, Volatile, Walrus, When, Where, While, With, WrappingAdd, WrappingAddAssign,
	WrappingDecrement, WrappingDivide, WrappingDivideAssign, WrappingIncrement, WrappingMinus, WrappingMinusAssign,
	WrappingPower, WrappingPowerAssign, WrappingShiftLeft, WrappingShiftLeftAssign, WrappingTimes, WrappingTimesAssign,
	Xor, XorAssign, Yield
}
